...
Date: ${formatDate(email.receivedTime)}
  ...
  const fetchAllCounts = async () => {
    ...
    try {
      ...
      const [sentResponse, archivedResponse, inboxResponse] = await Promise.all([
        ...
        axios.get(`${apiUrl}/zoho/emails/archived`, {
          headers: { Authorization: `Bearer ${accessToken}` },
        }),
        axios.get(`${apiUrl}/zoho/emails/inbox`, {
          headers: { Authorization: `Bearer ${accessToken}` },
        })
      ]);
  ...
  const handleDisconnect = () => {
    ...
    router.push('/dashboard?panel=integrations');
  };
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-amber-700">
                ...
                <button
                  onClick={() => router.push('/dashboard?panel=integrations')}
