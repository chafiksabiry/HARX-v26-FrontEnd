              ...
              <tbody className="divide-y">
                {currentDeals.length > 0 ? (
                  currentDeals.map((deal, index) => (
                    <tr key={deal.id || `deal-${index}`} className="hover:bg-gray-50">
                      <td className="py-3">
                      ...
                      <td className="py-3">
                        <div className="flex items-center gap-2">
                          <button onClick={() => deal.id && handleCall(deal.id)} className="p-2 hover:bg-gray-100 rounded-lg" disabled={!deal.id}>
                            <Phone className="w-5 h-5" />
                          </button>
                          <button onClick={() => deal.id && handleEmail(deal.id)} className="p-2 hover:bg-gray-100 rounded-lg" disabled={!deal.id}>
                            <Mail className="w-5 h-5" />
                          </button>
                          <button onClick={() => deal.id && handleChat(deal.id)} className="p-2 hover:bg-gray-100 rounded-lg" disabled={!deal.id}>
