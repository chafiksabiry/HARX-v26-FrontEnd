...
import { api as mainApi } from '@/lib/api'; // Use main API client for backend routes
...
export default function ContactCenterAssessment({ saveResults, onComplete, profileData }: ContactCenterAssessmentProps) {
  ...
  const generateScenario = async () => {
    ...
    try {
      ...
      // Use backend API route instead of OpenAI directly
      const response = await mainApi.post('/onboarding/assessments/generate-scenario', {
