...
const PrompAI: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (input.trim()) {
      // Directly start generating suggestions (will show loading screen)
  ...
  if (isAnalyzing) {
    return <LoadingScreen message="Analyzing your requirements and generating AI-powered suggestions..." />;
  }

  // Show review suggestions page after analysis
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="w-full h-full py-6 px-4 mx-auto max-w-5xl">
        <div className="text-center mb-12 animate-fade-in">
          <Logo className="mb-8 animate-fade-in-scale" />
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/30 p-8 animate-fade-in-scale">
