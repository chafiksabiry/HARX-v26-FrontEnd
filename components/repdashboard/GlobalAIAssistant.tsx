...
const globalState = {
  ...
  saveCallToDB: async () => {
    ...
    try {
      ...
      const result = await axios.post(`${process.env.NEXT_PUBLIC_API_URL_CALL}/api/calls/call-details`, {
      ...
      if (call.recordingUrl) {
        ...
        cloudinaryRecord = await axios.post(`${process.env.NEXT_PUBLIC_API_URL_CALL}/api/calls/fetch-recording`, {
      ...
      const callInDB = await axios.post(`${process.env.NEXT_PUBLIC_API_URL_CALL}/api/calls/store-call`, {
        CallSid: globalState.currentCallSid,
      ...
      if (currentMessages.length > 0) {
        ...
        const resultStock = await axios.post(`${process.env.VITE_API_URL_AI_MESSAGES}/messages/batch`, 
