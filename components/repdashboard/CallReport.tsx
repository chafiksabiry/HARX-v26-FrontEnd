...
import { vertexApi } from "../../app/dashboard/services/vertex";
import { callsApi } from "../../app/dashboard/services/calls";
...
function CallReportCard() {
    ...
    // In Next.js, we need to get the call from URL params or props
    // For now, we'll use null and handle it via props or URL params
    const callPased = null; // TODO: Get from URL params or props
    console.log("call object : ", callPased)

    const [call, setCall] = useState<Call | null>(callPased || null);
    const [report, setReport] = useState<CallReport>((callPased as Call | null)?.ai_call_score || initialReport);
